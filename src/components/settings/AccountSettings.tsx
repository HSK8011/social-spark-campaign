...
import PreferredQueueSettings from "./PreferredQueueSettings";
        ...
        <div className="flex mb-8 border-b">
          <div className="flex-grow-0 mr-6">
            ...
            <div className="space-y-1">
              ...
              <button
                className={`flex items-center gap-3 px-4 py-3 w-full text-left rounded-md ${
                  activeTab === 'queue' ? 'bg-blue-700 text-white' : 'hover:bg-gray-100'
                }`}
              ...
              <div>
                ...
                <div className="mb-6">
                  <div className="relative mb-8">
                    ...
                    <button className="absolute bottom-0 right-0 bg-blue-600 text-white p-1.5 rounded-full transform translate-x-1/4 translate-y-1/4 hover:bg-blue-700 transition-colors">
